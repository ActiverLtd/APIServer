...
activity3 = Activity.create(organizer: jesse, from: Time.now + 2.weeks + 4.days, to: Time.now + 2.weeks + 4.days + 5.hours, activity_type: activityTypes[2], location_name: 'Koiviston koulu', lat: 61.498172, lng: 23.755092, participant_count: 6, required_level: 3.0)
