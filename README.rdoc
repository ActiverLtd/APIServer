...
CID=$(docker run -d -v $(pwd)/app:/app/app -p 443:443 -p 1234:1234 -p 26126:26126 --net=bridge roopehakulinen/apiserver)
...
CID=$(docker run -d -p 443:443 roopehakulinen/apiserver);
